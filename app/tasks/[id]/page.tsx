...
const handleUpload = async (e: MouseEvent<HTMLButtonElement>) => {
  ...
  try {
    ...
    if (res.ok && data.success) {
      ...
      setUploadedFiles((prev) => [...prev, ...data.files]); // Store the uploaded file metadata
    } else {
  ...
  const renderComments = () => {
    ...
    return formData.comments.map((comment) => {
      // Parse or fallback
                          ...
                          >
                            ...
                            {options[field as keyof typeof options].map(
                              (
                                ...
                                <option key={idx} value={item.id || item.value}>
                    ...
                    <div className="mb-6 text-black">
                      <div className="flex items-center space-x-3">
                        ...
                        <button
                          ...
                          className="px-4 py-1 bg-blue-600 text-white rounded disabled:opacity-50 hover:bg-blue-700 transition"
                        >
                          Upload
                        </button>
                      </div>
